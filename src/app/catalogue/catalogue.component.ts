...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, MatButtonModule, MatCardModule, MatChipsModule, MatFormFieldModule, MatIconModule, MatInputModule, MatSelectModule],
  template: `
    <section class="catalogue-page">
      <header class="hero">
        <div>
          ...
          <p class="lead">
            Parcourez le fonds, filtrez par disponibilité et réservez un livre dès qu’il est emprunté.
          </p>
        </div>
      ...
      <section class="filters" aria-label="Filtres du catalogue">
        ...
        <mat-form-field appearance="outline">
          ...
          <mat-select [(ngModel)]="availability">
            ...
            <mat-option value="loaned">Empruntés</mat-option>
            <mat-option value="reserved">Réservés</mat-option>
          </mat-select>
        </mat-form-field>
      ...
      <section class="results-head">
        ...
        <button mat-button type="button"><mat-icon>filter_alt</mat-icon> Réinitialiser</button>
      </section>
...
export class CatalogueComponent {
  ...
  readonly quickFilters = ['Disponibles seulement', 'Nouveautés', 'Les mieux notés', 'Réservables'];
  ...
  readonly books: BookCard[] = [
    {
      ...
      rating: 4.8,
      status: 'loaned',
      summary: 'Un roman sensible sur la transmission, les saisons et la mémoire collective du quartier.',
      nextAvailable: '20/04/2026',
      queue: '3 réservations',
    },
    {
      ...
      rating: 4.5,
      status: 'reserved',
      summary: 'Une exploration des récits qui façonnent la culture populaire et les bibliothèques vivantes.',
      nextAvailable: '26/04/2026',
      queue: '1 réservation',
    },
    {
      ...
      rating: 4.2,
      status: 'available',
      summary: 'Une enquête immersive dans les rues et archives d’une ville qui semble changer la nuit.',
    },
    {
      ...
      rating: 4.6,
      status: 'available',
      summary: 'Carnet graphique pour suivre ses lectures, ses notes et ses recommandations personnelles.',
    },
  ];
  ...
  get filteredBooks(): BookCard[] {
    ...
    return this.books.filter((book) => {
      const matchesQuery = !normalizedQuery || [book.title, book.author, book.category, book.summary].some((value) =>
